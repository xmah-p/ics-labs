/*
 * memlib.c - a module that simulates the memory system.	Needed because
 *it allows us to interleave calls from the student's malloc package with the
 *system's malloc package in libc.
 */
#include "memlib.h"
 ...
 */
void mem_deinit(void) { munmap(heap, MAX_HEAP); }

/*
 * mem_reset_brk - reset the simulated brk pointer to make an empty heap
 */
void mem_reset_brk() { mem_brk = heap; }
 ...
 */
void* mem_heap_lo() { return (void*)heap; }
 ...
 */
size_t mem_heapsize() { return (size_t)((void*)mem_brk - (void*)heap); }
