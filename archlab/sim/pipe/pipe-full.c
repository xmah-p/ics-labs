...
{
    return ((imem_error) ? (F_NONE) : ((if_id_next->icode) == (I_JM)) ? 6 : 
      (imem_ifun));
}
...
long long gen_d_dstE()
{
    return (((if_id_curr->icode) == (I_RRMOVQ) || (if_id_curr->icode) == 
        (I_IRMOVQ) || (if_id_curr->icode) == (I_ALU) || (if_id_curr->icode)
         == (I_IADDQ) || (if_id_curr->icode) == (I_JM)) ? (if_id_curr->rb)
...
long long gen_aluA()
{
    return (((id_ex_curr->icode) == (I_RRMOVQ) || (id_ex_curr->icode) == 
        ...
        (id_ex_curr->icode) == (I_JM)) ? (id_ex_curr->valc) : (
...
long long gen_aluB()
{
    return (((id_ex_curr->icode) == (I_RMMOVQ) || (id_ex_curr->icode) == 
        ...
        (I_JM)) ? (id_ex_curr->valb) : ((id_ex_curr->icode) == (I_RRMOVQ)
...
{
    return ((((id_ex_curr->icode) == (I_RRMOVQ) || (id_ex_curr->icode) == 
          (I_JM)) & (!(ex_mem_next->takebranch))) ? (REG_NONE) : 
      (id_ex_curr->deste));
}
